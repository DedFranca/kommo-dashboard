...
export function GenericAreaChart({ title, subtitle, data, dataLabel = "Valor" }: Props) {
      ...
      <div className="min-h-0 flex-1">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={chartData} margin={{ top: 8, right: 12, bottom: 4, left: 0 }}>
            ...
            <Area type="monotone" dataKey="v" name={dataLabel} stroke="#6366f1" fill="url(#areaFill)" strokeWidth={2} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </Card>
